...
- Prompt inspiration: `11_Notes/Note - Prompt v03 - Pricing Precision Landing Page - Nordic Minimal Performance.md`
- Waitlist implementation reference: `11_Notes/Note - Max OS Waitlist Schema and Frontend Submit Pattern (Vite) (2026-03-07).md`
...
1. Pick one launch prompt variant from `11_Notes/Note - Prompt Pack - Max OS Launch Site (Vite, 3 Styles) (2026-03-07).md`.
...
1. Implement waitlist capture quickly using one of these patterns:
   ...
   - Use the exact payload and submit handler from `11_Notes/Note - Max OS Waitlist Schema and Frontend Submit Pattern (Vite) (2026-03-07).md`.
