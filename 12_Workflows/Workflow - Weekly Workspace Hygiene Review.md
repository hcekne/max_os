...
- Scan `00_System/` control files for client- or project-specific instructions that should live in project notes, historical logs, or [[00_System/Recurring Operations]] instead.
...
4. Scan `00_System/` control files for stale client- or project-specific references in global instructions.
...
11. Create or update a proposal in `00_System/Proposals/`.
...
The harness may only auto-delete files already in `16_Cleaning/Rubbish Bin/` when [[00_System/Rubbish Bin Policy]] allows it.
