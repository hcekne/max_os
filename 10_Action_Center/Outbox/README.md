...
- After delivery, move items to `16_Cleaning/Archive/10_Action_Center/Outbox/` (historical value) or `16_Cleaning/Rubbish Bin/10_Action_Center/Outbox/` (low retention).
...
## Suggested prompt
"List everything in `10_Action_Center/Outbox/`, who each item is for, what canonical source it came from, and whether it has been delivered yet."
