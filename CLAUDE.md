# Max OS — Claude Code Instructions
...
1. `00_System/LLM Operating Manual.md` — full instruction set and algorithms
2. `00_System/System State.md` — current dates, active plans, and review checkpoints
3. `00_System/Indexes.md` — where each type of note belongs
4. `SKILLS.md` — agent-executable capabilities
