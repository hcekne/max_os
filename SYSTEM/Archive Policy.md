...
Use [[SYSTEM/Document Lifecycle Policy]] for classification. This file defines what the archive path means and how to use it.
...
## Archive Structure
- Archive root: `SYSTEM/Cleaning/Archive/`
...
```text
SYSTEM/Cleaning/Archive/
	KNOWLEDGE/Projects/<Project Name>/...
	KNOWLEDGE/Content/<Content Family>/...
	KNOWLEDGE/Notes/...
```

## Archive Indexing
- `SYSTEM/Cleaning/Archive/Index.md` should record significant moves and archive conventions.
...
3. Use `git mv` into `SYSTEM/Cleaning/Archive/...`.
