...
Store these in `KNOWLEDGE/Content/Artifacts/`.
...
Store these in `AUTOMATE/Modules/Worklets/`.
...
- Static HTML artifacts: `KNOWLEDGE/Content/Artifacts/`
- Interactive HTML worklets: `AUTOMATE/Modules/Worklets/`
- Companion manifests: next to the artifact or worklet, using the relevant manifest template from `SYSTEM/Templates/`
