...
last_yearly_review_date: 2026-01-01
active_week_plan: [[PLAN/Weekly/2026-W09]]
active_month_note: 
active_quarter_plan: [[PLAN/Quarterly/2026-Q1]]
active_year_note: 
active_two_year_plan: [[PLAN/Two-Year/Two-Year Goal State]]
active_goals: []
active_modules: []
---
...
Single source of truth for the latest planning checkpoints.
...
- `active_goals` can list links to current goal notes in `PLAN/Goals/`.
