...
Identity surface for whoever (or whatever) owns this workspace. Read at session start to recover *who is acting* and *what they are allowed to do*. See [[SYSTEM/AI Actor & Memory Model]] for how this fits the memory model.
