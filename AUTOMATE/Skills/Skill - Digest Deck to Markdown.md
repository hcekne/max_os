...
- Output location: default `KNOWLEDGE/Content/`, or an explicitly requested destination such as a project folder under `KNOWLEDGE/Projects/`
- Priority: accuracy and completeness over speed

## Inputs
- One or more source presentation decks as PDF
- Optional output filename
- Optional destination path under `KNOWLEDGE/Content/` or a project folder such as `KNOWLEDGE/Projects/<Project Name>/`
...
2. Confirm the output location, defaulting to `KNOWLEDGE/Content/` unless the user requested a project-scoped destination.
