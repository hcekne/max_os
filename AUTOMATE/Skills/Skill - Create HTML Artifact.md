...
- Optional output filename under `KNOWLEDGE/Content/Artifacts/`
...
7. Create or update an artifact manifest from `SYSTEM/Templates/TPL - Artifact Manifest.md` when the artifact is meaningful enough to track.
8. If the artifact suggests canonical changes, write them as a Markdown proposal instead of changing source notes silently.

## Outputs
- HTML artifact in `KNOWLEDGE/Content/Artifacts/`
