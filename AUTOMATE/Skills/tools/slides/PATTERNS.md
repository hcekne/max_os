...
```bash
cd AUTOMATE/Skills/tools/slides/_gallery
...
Use `node AUTOMATE/Skills/tools/slides/build_deck_pdf.mjs <deck_folder>/deck.html` to produce a PDF that matches the HTML preview exactly.
