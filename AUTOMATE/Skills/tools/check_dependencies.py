...
See `SYSTEM/Guides/Guide - System Dependencies.md` for the canonical reference.
"""
...
def main() -> None:
    results = [
        check_command(
            "python3",
            "every Python tool in AUTOMATE/Skills/tools/",
            "brew install python@3",
        ),
        check_command(
            "node",
            "running AUTOMATE/Skills/tools/slides/check_deck_visual.mjs (headless visual QA)",
            "brew install node",
        ),
        check_command(
            "pandoc",
