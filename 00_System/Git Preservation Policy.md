...
- Default old low-value versions into `16_Cleaning/Rubbish Bin/` unless the archive path is clearly better.

## Deletion Standard
- Outside the rubbish-bin purge path, deletion requires explicit human approval and a recorded reason.
- Files already in `16_Cleaning/Rubbish Bin/` may be deleted without separate case-by-case approval if they satisfy [[00_System/Rubbish Bin Policy]].
