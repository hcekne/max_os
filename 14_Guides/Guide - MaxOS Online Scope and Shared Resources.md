...
- **Personal workspace** — the owner's private numbered folders and notes.
...
Executable workflows live in `12_Workflows/Automations/` and are identified by
...
`12_Workflows/Automations/artifacts/`. Final leaf outputs are delivered to the
